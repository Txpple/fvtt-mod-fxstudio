...
// whitelist in core/fx.js, read in the sentence as "a custom effect". Place words in an
...
import { CUSTOM_WHITELIST } from '../../core/fx.js';
import { PLACES } from '../../core/fx.js';
...
export function build(seq, scene, ctx) {
  ...
  let section = null;
  const arg = (a) => {
    if (typeof a === 'string' && PLACES.includes(a)) { const spot = spotsFor(a, moment, { fxName: ctx.fx.id })[0]; return spot ? spotTarget(spot) : a; }
    return a;
  };
